...
const ThingsToDo = () => {
  ...
  return (
    <div className="thingsToDoContainer">
      <div className="thingsToDo">
        ...
        <div className="thingsToDo__details item__container">
          <ScrollTrigger onEnter={() => setIsVisible(true)}>
            <h1
              className={
                isVisible ? "item--heading moveInDown" : "item--heading"
              }
            >
              Things <br />
              to do
            ...
            <h4
              className={
                isVisible ? "item--sub-heading moveInLeft" : "item--sub-heading"
              }
            >
              Exist to create
            </h4>
      ...
      <ScrollTrigger onEnter={() => setIsGridVisible(true)}>
        <div className="thingsToDo__sub-grid">
          <div
            className={
              isGridVisible
                ? "thingsToDo__sub-grid--1 item__container moveInDown"
                : "thingsToDo__sub-grid--1 item__container"
            }
          >
            <svg
              version="1.1"
          ...
          <div
            className={
              isGridVisible
                ? "thingsToDo__sub-grid--2 item__container moveInUp"
                : "thingsToDo__sub-grid--2 item__container"
            }
          >
            <svg
              version="1.1"
          ...
          <div
            className={
              isGridVisible
                ? "thingsToDo__sub-grid--3 item__container moveInDown"
                : "thingsToDo__sub-grid--3 item__container"
            }
          >
            <svg
              version="1.1"
