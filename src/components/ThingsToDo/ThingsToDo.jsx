  ...
  return (
    <div className="thingsToDoContainer">
      ...
      <div className="thingsToDo__sub-grid">
        <div className="thingsToDo__sub-grid--1 item__container">
          <svg
            version="1.1"
        ...
        <div className="thingsToDo__sub-grid--2 item__container">
          <svg
            version="1.1"
            xmlns="http://www.w3.org/2000/svg"
            width="32"
        ...
        <div className="thingsToDo__sub-grid--3 item__container">
          <svg
            version="1.1"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
