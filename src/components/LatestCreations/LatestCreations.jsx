...
const LatestCreations = () => {
  return (
    <div className="latestCreationsContainer">
      ...
      <figure className="latestCreations--1">
        <img
      ...
      <figure className="latestCreations--2">
        <img
          className="latestCreations__img"
      ...
      <figure className="latestCreations--3">
        <img
          className="latestCreations__img"
      ...
      <figure className="latestCreations--4">
        <img
          className="latestCreations__img"
      ...
      <figure className="latestCreations--5">
        <img
          className="latestCreations__img"
      ...
      <figure className="latestCreations--6">
        <img
          className="latestCreations__img"
      ...
      <figure className="latestCreations--7">
        <img
          className="latestCreations__img"
